...
void nrf_loop()
{
    ...
    {                                    // if receive the data
        ...
        Serial.print(Pack.pot_1);
        Serial.print('\t');
        Serial.print(Pack.pot_2);
        Serial.print('\t');
        Serial.print(Pack.joystick_x);
        Serial.print('\t');
        Serial.print(Pack.joystick_y);
        Serial.print('\t');
        Serial.print(Pack.joystick_z);
        Serial.print('\t');
        Serial.print(Pack.s_1);
        Serial.print('\t');
        Serial.print(Pack.s_2);
        Serial.print('\t');
        Serial.print(Pack.s_3);
        Serial.print('\n');
    }
}